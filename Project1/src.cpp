...
int InitGL(GLvoid) // All Setup For OpenGL Goes Here
{
	...
	//wood = LoadTexture("wood_texture_edited.bmp",255);
	//quttun = LoadTexture("wood_texture_edited.bmp",255);
	//iron = LoadTexture("wood_texture_edited.bmp",255);
...
void DrawGLScene() // Here's Where We Do All The Drawing
{
	...
	bedroom.buildRoom(wood,quttun,iron);
